...
from .operations.hsm_security_domain_operations import HSMSecurityDomainOperations
...
class KeyVaultClient(SDKClient):
    ...
    :vartype hsm_security_domain: securitydomain.operations.HSMSecurityDomainOperations
    :ivar role_definitions: RoleDefinitions operations
    :vartype role_definitions: rbac.operations.RoleDefinitionsOperations
    :ivar role_assignments: RoleAssignments operations
    :vartype role_assignments: rbac.operations.RoleAssignmentsOperations
    ...
    def full_backup(
            self, vault_base_url, azure_storage_blob_container_uri=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param azure_storage_blob_container_uri: Azure blob shared access
         signature token pointing to a valid Azure blob container where full
         backup needs to be stored. This token needs to be valid for at least
         next 24 hours from the time of making this call
        :type azure_storage_blob_container_uri:
         ~backuprestore.models.SASTokenParameter
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: FullBackupOperation or ClientRawResponse if raw=true
        :rtype: ~backuprestore.models.FullBackupOperation or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<backuprestore.models.KeyVaultErrorException>`
        """
        # Construct URL
        url = self.full_backup.metadata['url']
        ...
        return deserialized
    full_backup.metadata = {'url': '/backup'}

    def full_backup_status(
            self, vault_base_url, job_id, custom_headers=None, raw=False, **operation_config):
    ...
    def full_restore_operation(
            self, vault_base_url, restore_blob_details=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param vault_base_url: The vault name, for example
         https://myvault.vault.azure.net.
        :type vault_base_url: str
        :param restore_blob_details: The Azure blob SAS token pointing to a
         folder where the previous successful full backup was stored
        :type restore_blob_details:
         ~backuprestore.models.RestoreOperationParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: RestoreOperation or ClientRawResponse if raw=true
        :rtype: ~backuprestore.models.RestoreOperation or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<backuprestore.models.KeyVaultErrorException>`
        """
        # Construct URL
        url = self.full_restore_operation.metadata['url']
        path_format_arguments = {
            'vaultBaseUrl': self._serialize.url("vault_base_url", vault_base_url, 'str', skip_quote=True)
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    full_restore_operation.metadata = {'url': '/restore'}
    ...
    def restore_status(
        ...
        """
        # Construct URL
        url = self.restore_status.metadata['url']
        path_format_arguments = {
            'vaultBaseUrl': self._serialize.url("vault_base_url", vault_base_url, 'str', skip_quote=True),
            'jobId': self._serialize.url("job_id", job_id, 'str')
        }
    ...
    def selective_key_restore_operation_method(
            self, vault_base_url, key_name, restore_blob_details=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param vault_base_url: The vault name, for example
         https://myvault.vault.azure.net.
        :type vault_base_url: str
        :param key_name: The name of the key to be restored from the user
         supplied backup
        :type key_name: str
        :param restore_blob_details: The Azure blob SAS token pointing to a
         folder where the previous successful full backup was stored
        :type restore_blob_details:
         ~backuprestore.models.SelectiveKeyRestoreOperationParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: SelectiveKeyRestoreOperation or ClientRawResponse if raw=true
        :rtype: ~backuprestore.models.SelectiveKeyRestoreOperation or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<backuprestore.models.KeyVaultErrorException>`
        """
        # Construct URL
        url = self.selective_key_restore_operation_method.metadata['url']
        path_format_arguments = {
            'vaultBaseUrl': self._serialize.url("vault_base_url", vault_base_url, 'str', skip_quote=True),
        ...
        if response.status_code == 202:
            deserialized = self._deserialize('SelectiveKeyRestoreOperation', response)
            header_dict = {
                'Retry-After': 'int',
                'Azure-AsyncOperation': 'str',
            }
        ...
        return deserialized
    selective_key_restore_operation_method.metadata = {'url': '/keys/{keyName}/restore'}
    ...
    def get_certificates(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: CertificateListResult or ClientRawResponse if raw=true
        :rtype: ~certificates.models.CertificateListResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<certificates.models.KeyVaultErrorException>`
        """
        # Construct URL
    ...
    def delete_certificate(
        ...
        :rtype: ~certificates.models.DeletedCertificateBundle or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<certificates.models.KeyVaultErrorException>`
        """
    ...
    def set_certificate_contacts(
            self, vault_base_url, contacts, custom_headers=None, raw=False, **operation_config):
        ...
        :type contacts: ~certificates.models.Contacts
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~certificates.models.Contacts or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<certificates.models.KeyVaultErrorException>`
        """
    ...
    def get_certificate_issuers(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: CertificateIssuerListResult or ClientRawResponse if raw=true
        :rtype: ~certificates.models.CertificateIssuerListResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<certificates.models.KeyVaultErrorException>`
        """
    ...
    def set_certificate_issuer(
        ...
        :type credentials: ~certificates.models.IssuerCredentials
        :param organization_details: Details of the organization as provided
         to the issuer.
        :type organization_details: ~certificates.models.OrganizationDetails
        :param attributes: Attributes of the issuer object.
        :type attributes: ~certificates.models.IssuerAttributes
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~certificates.models.IssuerBundle or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<certificates.models.KeyVaultErrorException>`
        """
    ...
    def create_certificate(
        ...
        :type certificate_policy: ~certificates.models.CertificatePolicy
        :param certificate_attributes: The attributes of the certificate
         (optional).
        :type certificate_attributes:
         ~certificates.models.CertificateAttributes
        ...
        :rtype: ~certificates.models.CertificateOperation or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<certificates.models.KeyVaultErrorException>`
        """
    ...
    def import_certificate(
        ...
        Azure Key Vault. This operation requires the certificates/import
        permission. The certificate to be imported can be in either PFX or PEM
        format. If the certificate is in PEM format the PEM file must contain
        the key as well as x509 certificates. Key Vault will only accept a key
        in PKCS#8 format.
        ...
        :rtype: ~certificates.models.CertificateBundle or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<certificates.models.KeyVaultErrorException>`
        """
    ...
    def get_certificate_policy(
        ...
        :rtype: ~certificates.models.CertificatePolicy or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<certificates.models.KeyVaultErrorException>`
        """
    ...
    def get_certificate(
        ...
        :param certificate_name: The name of the certificate in the given
         vault.
        :type certificate_name: str
        :param certificate_version: The version of the certificate. This URI
         fragment is optional. If not specified, the latest version of the
    ...
    def backup_certificate(
        ...
        :rtype: ~certificates.models.BackupCertificateResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<certificates.models.KeyVaultErrorException>`
        """
    ...
    def get_deleted_certificates(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: DeletedCertificateListResult or ClientRawResponse if raw=true
        :rtype: ~certificates.models.DeletedCertificateListResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<certificates.models.KeyVaultErrorException>`
        """
    ...
    def create_key(
            self, vault_base_url, key_name, kty, key_size=None, public_exponent=None, key_ops=None, key_attributes=None, tags=None, curve=None, release_policy=None, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype: ~keys.models.KeyBundle or ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<keys.models.KeyVaultErrorException>`
        """
    ...
    def delete_key(
        ...
        :rtype: ~keys.models.DeletedKeyBundle or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<keys.models.KeyVaultErrorException>`
        """
    ...
    def get_key(
        ...
        :param key_version: Adding the version parameter retrieves a specific
         version of a key. This URI fragment is optional. If not specified, the
    ...
    def get_key_versions(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: KeyListResult or ClientRawResponse if raw=true
        :rtype: ~keys.models.KeyListResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<keys.models.KeyVaultErrorException>`
        """
    ...
    def backup_key(
        ...
        :rtype: ~keys.models.BackupKeyResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<keys.models.KeyVaultErrorException>`
        """
    ...
    def encrypt(
            self, vault_base_url, key_name, key_version, algorithm, value, iv=None, aad=None, tag=None, custom_headers=None, raw=False, **operation_config):
        ...
        :rtype: ~keys.models.KeyOperationResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<keys.models.KeyVaultErrorException>`
        """
    ...
    def sign(
        ...
        :param algorithm: The signing/verification algorithm identifier. For
         ...
         'ES384', 'ES512', 'ES256K'
        :type algorithm: str or ~keys.models.JsonWebKeySignatureAlgorithm
        :param value:
        :type value: bytes
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
    ...
    def verify(
        ...
        :rtype: ~keys.models.KeyVerifyResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<keys.models.KeyVaultErrorException>`
        """
    ...
    def export(
            self, vault_base_url, key_name, key_version, wrapping_key=None, wrapping_kid=None, enc=None, custom_headers=None, raw=False, **operation_config):
        """Exports a key.
        ...
        :param key_version: Adding the version parameter retrieves a specific
         version of a key.
        :type key_version: str
        :param wrapping_key: The export key encryption Json web key. This key
         MUST be a RSA key that supports encryption.
        :type wrapping_key: ~keys.models.JsonWebKey
        :param wrapping_kid: The export key encryption key identifier. This
         key MUST be a RSA key that supports encryption.
        :type wrapping_kid: str
        :param enc: The encryption algorithm to use to protected the exported
         key material. Possible values include: 'CKM_RSA_AES_KEY_WRAP',
        ...
        :raises:
         :class:`KeyVaultErrorException<keys.models.KeyVaultErrorException>`
        """
        parameters = models.KeyExportParameters(wrapping_key=wrapping_key, wrapping_kid=wrapping_kid, enc=enc)
    ...
    def release(
            self, vault_base_url, key_name, key_version, target, nonce=None, enc=None, custom_headers=None, raw=False, **operation_config):
        """Releases a key.

        The release key operation is applicable to all key types. The target
        key must be marked exportable. This operation requires the keys/release
        permission.
        ...
        :param key_version: Adding the version parameter retrieves a specific
         version of a key.
        :type key_version: str
        :param target: The attestation assertion for the target of the key
         release.
        :type target: str
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: KeyReleaseResult or ClientRawResponse if raw=true
        :rtype: ~keys.models.KeyReleaseResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<keys.models.KeyVaultErrorException>`
        """
        parameters = models.KeyReleaseParameters(target=target, nonce=nonce, enc=enc)

        # Construct URL
        url = self.release.metadata['url']
        path_format_arguments = {
            'vaultBaseUrl': self._serialize.url("vault_base_url", vault_base_url, 'str', skip_quote=True),
            'key-name': self._serialize.url("key_name", key_name, 'str'),
            'key-version': self._serialize.url("key_version", key_version, 'str')
        ...
        # Construct body
        body_content = self._serialize.body(parameters, 'KeyReleaseParameters')
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('KeyReleaseResult', response)
    ...
    def get_deleted_keys(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: DeletedKeyListResult or ClientRawResponse if raw=true
        :rtype: ~keys.models.DeletedKeyListResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<keys.models.KeyVaultErrorException>`
        """
    ...
    def get_random_bytes(
            self, vault_base_url, count, custom_headers=None, raw=False, **operation_config):
        """Get the requested number of bytes containing random values.

        Get the requested number of bytes containing random values from a
        managed HSM.
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: RandomBytes or ClientRawResponse if raw=true
        :rtype: ~keys.models.RandomBytes or ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<keys.models.KeyVaultErrorException>`
        """
        parameters = models.GetRandomBytesRequest(count=count)

        # Construct URL
        url = self.get_random_bytes.metadata['url']
        path_format_arguments = {
            'vaultBaseUrl': self._serialize.url("vault_base_url", vault_base_url, 'str', skip_quote=True)
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        # Construct body
        body_content = self._serialize.body(parameters, 'GetRandomBytesRequest')
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('RandomBytes', response)
    ...
    def set_secret(
        ...
        :type secret_attributes: ~secrets.models.SecretAttributes
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: ~secrets.models.SecretBundle or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<secrets.models.KeyVaultErrorException>`
        """
    ...
    def delete_secret(
        ...
        :rtype: ~secrets.models.DeletedSecretBundle or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<secrets.models.KeyVaultErrorException>`
        """
    ...
    def get_secret(
        ...
        :param secret_name: The name of the secret.
        :type secret_name: str
        :param secret_version: The version of the secret. This URI fragment is
         optional. If not specified, the latest version of the secret is
         returned.
        :type secret_version: str
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
    ...
    def get_secrets(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: SecretListResult or ClientRawResponse if raw=true
        :rtype: ~secrets.models.SecretListResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<secrets.models.KeyVaultErrorException>`
        """
    ...
    def get_deleted_secrets(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: DeletedSecretListResult or ClientRawResponse if raw=true
        :rtype: ~secrets.models.DeletedSecretListResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<secrets.models.KeyVaultErrorException>`
        """
    ...
    def backup_secret(
        ...
        :rtype: ~secrets.models.BackupSecretResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<secrets.models.KeyVaultErrorException>`
        """
    ...
    def get_storage_accounts(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: StorageListResult or ClientRawResponse if raw=true
        :rtype: ~storage.models.StorageListResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<storage.models.KeyVaultErrorException>`
        """
        # Construct URL
    ...
    def get_deleted_storage_accounts(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: DeletedStorageListResult or ClientRawResponse if raw=true
        :rtype: ~storage.models.DeletedStorageListResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<storage.models.KeyVaultErrorException>`
        """
    ...
    def get_deleted_storage_account(
        ...
        :rtype: ~storage.models.DeletedStorageBundle or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<storage.models.KeyVaultErrorException>`
        """
    ...
    def recover_deleted_storage_account(
        ...
        :rtype: ~storage.models.StorageBundle or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<storage.models.KeyVaultErrorException>`
        """
    ...
    def backup_storage_account(
        ...
        :rtype: ~storage.models.BackupStorageResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<storage.models.KeyVaultErrorException>`
        """
    ...
    def set_storage_account(
        ...
        :type storage_account_attributes:
         ~storage.models.StorageAccountAttributes
        :param tags: Application specific metadata in the form of key-value
         pairs.
        :type tags: dict[str, str]
        :param dict custom_headers: headers that will be added to the request
    ...
    def get_sas_definitions(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: SasDefinitionListResult or ClientRawResponse if raw=true
        :rtype: ~storage.models.SasDefinitionListResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<storage.models.KeyVaultErrorException>`
        """
    ...
    def get_deleted_sas_definitions(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: DeletedSasDefinitionListResult or ClientRawResponse if
         raw=true
        :rtype: ~storage.models.DeletedSasDefinitionListResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<storage.models.KeyVaultErrorException>`
        """
    ...
    def get_deleted_sas_definition(
        ...
        :rtype: ~storage.models.DeletedSasDefinitionBundle or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<storage.models.KeyVaultErrorException>`
        """
    ...
    def recover_deleted_sas_definition(
        ...
        :rtype: ~storage.models.SasDefinitionBundle or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`KeyVaultErrorException<storage.models.KeyVaultErrorException>`
        """
    ...
    def set_sas_definition(
        ...
        :type sas_definition_attributes:
         ~storage.models.SasDefinitionAttributes
        :param tags: Application specific metadata in the form of key-value
         pairs.
        :type tags: dict[str, str]
        :param dict custom_headers: headers that will be added to the request
